...
func setChannelRoute(api *gin.RouterGroup) {
	...
	{
		channels_group.GET("/:id", rest.GetChannelInfo)      //ChannelsController_getChannelInfo
		channels_group.GET("/:id/home", rest.GetChannelHome) //ChannelsController_getChannelHome
